    ...
    <div>
      <b-navbar>
          <template #start>
              ...
              <router-link v-if="isAuthen() && isAdmin()" class="navbar-item" to="/admin/spareparts">Admin-Spareparts</router-link>
              <router-link v-if="isAuthen() && isAdmin()" class="navbar-item" to="/admin/manufacturer">Admin-Manufacturer</router-link>
          </template>
          <template #end>
              <b-navbar-item tag="div">
                  <div class="buttons">
                      <div id="icon" v-if="isAuthen() && !isAdmin()">
